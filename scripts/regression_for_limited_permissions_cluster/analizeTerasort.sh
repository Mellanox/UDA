...
do
	...
	jobHeader="
			<tr bgcolor='LightSkyBlue'>
				<td colspan='6'>$job - Shuffle-Con. $shuffC, Data-set: ${tslDATA_SET}Gb, #Disks: $DISKS, #Samples: ${tslSAMPLES}</td>
			</tr>"
		...
		do
			...
			testsValues="$testsValues
				<tr> 
					...
					<td>$exlMAP_SLAVES_COUNT</td>
					<td>$exlREDUCE_SLAVES_COUNT</td>
					<td>$exlMAPREDUCE_SLAVES_COUNT</td>
					<td>$jobDuration</td>
