...
cp uda-hadoop-1.x.jar uda-hadoop-3.x.jar uda-CDH3u4.jar libuda.so README LICENSE.txt journal.txt set_hadoop_slave_property.sh source.tgz ~/rpmbuild/SOURCES/
