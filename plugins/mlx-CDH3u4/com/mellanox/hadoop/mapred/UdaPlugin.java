...
class UdaPluginRT<K,V> extends UdaPlugin implements UdaCallable {
	...
	protected void buildCmdParams() {
		...
		String s1 = TaskLog.getTaskLogFile(reduceTask.getTaskID(), false, TaskLog.LogName.STDOUT).toString(); //userlogs/attempt_201208301702_0002_r_000002_0/stdout
...
//0.20.2	    	 runAsUserName = taskTracker.getTaskController().getRunAsUser(jobConf);
