...
//UDA import static org.apache.hadoop.mapred.MapTask.MAP_OUTPUT_INDEX_RECORD_LENGTH;
//import static IndexCache.MAP_OUTPUT_INDEX_RECORD_LENGTH; //UDA
...
class SpillRecord {
  ...
  public SpillRecord(int numPartitions) {
    buf = ByteBuffer.allocate(
        numPartitions * IndexCache.MAP_OUTPUT_INDEX_RECORD_LENGTH);
  ...
  public SpillRecord(Path indexFileName, JobConf job, Checksum crc)
    ...
    try {
      ...
      final int size = partitions * IndexCache.MAP_OUTPUT_INDEX_RECORD_LENGTH;
   ...
   */
  public int size() {
    return entries.capacity() / (IndexCache.MAP_OUTPUT_INDEX_RECORD_LENGTH / 8);
  }
  ...
  public IndexRecord getIndex(int partition) {
    final int pos = partition * IndexCache.MAP_OUTPUT_INDEX_RECORD_LENGTH / 8;
